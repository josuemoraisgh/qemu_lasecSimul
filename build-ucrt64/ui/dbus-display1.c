...
static const _ExtendedGDBusArgInfo _qemu_dbus_display1_chardev_method_info_register_IN_ARG_listener =
{
  {
    -1,
    (gchar *) "listener",
...
{
  &_qemu_dbus_display1_chardev_method_info_register_IN_ARG_listener.parent_struct,
  NULL
};
